    ...
    <div class="order-list">
        ...
        <div class="order-list-box">
            ...
            <div class="role-button">
                <span @click="handleClick('/home/home_add_company','add')">
                    添加商户
                </span>
            </div>
            ...
            <div class="table">
                ...
                <table ref="table">
                    ...
                    <tr v-for="items in companyList">
                        ...
                        <td>{{items.score}}</td>
                        <td>
                            <span class="button" @click="handleClick('/home/home_edit_company',items)"><i class="fa fa-pencil fa-lg"></i>编辑</span>
                            <span class="button" @click="handleClick('/home/home_edit_company_password',items)"><i class="fa fa-key fa-lg"></i>修改密码</span>
                            <span class="button" @click="changeCompanyState('冻结',items.id)"><i class="fa fa-ban fa-lg"></i>冻结</span>
                            <span class="button" @click="changeCompanyState('解冻',items.id)"><i class="fa fa-share fa-lg"></i>解冻</span>
                        </td>
                    </tr>
        ...
        methods: {
            ...
            changeCompanyState(status,id) {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/Mancompany/operation?id="+id,
            ...
            searchState(event) {
                ...
                this.scState = event.currentTarget.value

                this.getSearchStateList(1)
            ...
            handleClick(path,obj) {
                ...
                this.$store.commit('setCompanyDetail',obj)
