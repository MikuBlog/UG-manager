    ...
    <div class="role">
        ...
        <div class="role-box">
            ...
            <div class="role-button">
                <span @click="handleClick('/home/home_edit_role','add')">
                    添加角色
                </span>
            </div>
            ...
            <div class="table">
                ...
                <table ref="table">
                    ...
                    <tr v-for="items in roleList">
                        <td><span class="icon"><i class="fa fa-plus-square-o fa-lg" @click="showDetail($event,items.permission_id)"></i></span></td>
                        <td>{{items.name}}</td>
                        <td>{{items.createtime}}</td>
                        <td>
                            <span class="button" @click="handleClick('/home/home_edit_role','edit')"><i class="fa fa-pencil fa-lg"></i>编辑</span>
                        ...
                        <td colspan="4">
                            <div class="behavior">
                                <div class="behavior-box">
                                    ...
                                    <span v-for="items in behaviorList">{{items}}</span>
                                </div> 
                            </div>
                        </td>
                    </tr>
        ...
        methods: {
            ...
            getSearchNameList(id) {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/role/search?pageMax="+_this.perPage+"&page="+id,
            ...
            getSearchAllList(id) {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/role/all?pageMax="+_this.perPage+"&page="+id,
