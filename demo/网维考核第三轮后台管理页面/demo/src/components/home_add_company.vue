            ...
            <div class="company-form-box">
                ...
                <div class="company-box box">
                    ...
                    <div class="boxs">
                        ...
                        <div class="company-loginname">
                            ...
                            <div>
                                <input type="text" placeholder="请输入登录名" v-model="userName" class="input">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                <input type="text" placeholder="请输入密码" v-model="userPassword" class="input">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                <input type="text" placeholder="请确认密码" v-model="espassword" class="input">
                            </div>
                        </div>
                    ...
                    <div class="company-detail-first">
                        ...
                        <div class="company-name">
                            ...
                            <div>
                                <input type="text" placeholder="请输入公司名" v-model="name" class="input">
                            </div>
                        </div>
                    ...
                    <div class="company-position">
                        ...
                        <div>
                            <input type="text" placeholder="请输入详细地址" v-model="detail" class="input">
                        </div>
                ...
                <div class="company-contact box">
                    ...
                    <div class="contact-form-box">
                        ...
                        <div class="contact-name">
                            ...
                            <div>
                                <input type="text" placeholder="请输入联系人姓名" v-model="contactName" class="input">
                            </div>
                        </div>
                        ...
                        <div class="contact-phone">
                            ...
                            <div>
                                <input type="text" placeholder="请输入联系人电话" v-model="contactPhone" class="input">
                            </div>
                        </div>
                        ...
                        <div class="contact-name">
                            ...
                            <div>
                                <input type="text" placeholder="请输入身份证号码" v-model="idCard" class="input">
                            </div>
                        </div>
                ...
                <div class="company-server box">
                    ...
                    <div class="server-code">
                        ...
                        <div>
                            <input type="text" placeholder="请输入统一社会信用代码" v-model="code" class="input">
                        </div>
                    </div>
        ...
        methods: {
            ...
            sendMessage() {
                ...
                var data = {
                    ...
                    range:this.alreadyHasBusinessList

                }

                $.ajax({

                    url:"http://118.24.136.82/index.php/index/mancompany/regsiter",
