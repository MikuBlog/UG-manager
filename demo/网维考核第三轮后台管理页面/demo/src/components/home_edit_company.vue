                ...
                <div class="company-box box">
                    ...
                    <div class="boxs boxsss">
                        ...
                        <div class="company-loginname">
                            ...
                            <div>
                                <input type="text" :placeholder="companyDetail.userName" v-model="userName" class="input">
                            </div>
                        </div>
        ...
        methods: {
            ...
            sendMessage() {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/mancompany/edit?id="+_this.companyDetail.id,
