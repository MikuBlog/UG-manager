        ...
        methods: {
            ...
            downloadDocument() {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/C_Company_Bill/out?button=导出",
            ...
            searchList(id) {
                ...
                var data = {
                    ...
                    createtime:time.year+"-"+time.month+"-"+time.day,
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/C_Company_Bill/search?pagesize="+_this.perPage+"&pagenow="+id,
            ...
            getbillDetailList(id) {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/C_Company_Bill/show?pagesize="+_this.perPage+"&pagenow="+id,
