    ...
    <div class="role">
        ...
        <div class="role-box">
            ...
            <div class="role-button">
                <span @click="handleClick('/home/company_edit_role','add')">
                    添加角色
                </span>
            </div>
            ...
            <div class="table">
                ...
                <table ref="table">
                    ...
                    <tr v-for="(items,index) in roleList">
                        <td><span class="icon"><i class="fa fa-plus-square-o fa-lg" @click="showDetail($event,index)"></i></span></td>
                        <td>{{items.name}}</td>
                        <td>{{items.createtime}}</td>
                        <td>
                            <span class="button" @click="handleClick('/home/company_edit_role','edit',items)"><i class="fa fa-pencil fa-lg"></i>编辑</span>
                            <span class="button" @click="deleteRole(items.id)"><i class="fa fa-trash fa-lg"></i>删除</span>
                        </td>
                    </tr>
                        ...
                        <td colspan="4">
                            <div class="behavior">
                                <div class="behavior-box">
                                    ...
                                    <span v-for="items in behaviorList.range">{{items}}</span>
                                </div> 
                            </div>
                        </td>
                    </tr>
        ...
        methods: {
            ...
            deleteRole(id) {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/Company_Role/delete",
            ...
            showDetail(event,index) {
                ...
                this.behaviorList = this.permission[index]
            },

            // 跳转路由
            handleClick(path,command,items) {
                ...
                this.$store.commit('setRoleDetail',items)
            ...
            getRoleList(id) {
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/Company_Role/showList?pageMax="+_this.perPage+"&page="+id,
                    ...
                    success(data) {
                        ...
                        _this.permission = obj.permission
