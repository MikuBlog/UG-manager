            ...
            <div class="person-form">
                ...
                <div class="person-mes bigbox">
                    ...
                    <div class="boxs">
                        <div>
                            ...
                            <div><input type="text" :placeholder="workerDetail.staffId" v-model="staffId"></div>
                            <span ref="id" class="warn"></span>
                        </div>

                        <div>
                            <span class="mes">登录名:</span>
                            <div><input type="text" :placeholder="workerDetail.loginName" v-model="loginName"></div>
                    ...
                    <div class="boxs">
                        ...
                        <div>
                            ...
                            <div><input type="text" :placeholder="workerDetail.name" v-model="name"></div>
                            <span ref="name" class="warn"></span>
                        </div>

                        <div>
                            <span class="mes">电话:</span>
                            <div><input type="text" :placeholder="workerDetail.phone" v-model="phone"></div>
                    ...
                    <div>
                        ...
                        <div><input type="text" :placeholder="workerDetail.idCard" v-model="idCard"></div>
                ...
                <div class="person-role bigbox">
                    ...
                    <div class="person-search">
                        <div class="search">
                            <i class="fa fa-search fa-lg"></i><input type="text" @keydown="searchName($event)" v-model="scName">
                        </div>
        ...
        methods: {
            ...
            sendMessage() {
                ...
                var data = {
                    ...
                    id:this.workerDetail.id,

                    staffId:this.staffId || this.workerDetail.staffId,

                    loginName:this.loginName || this.workerDetail.loginName,

                    name:this.name || this.workerDetail.name,

                    phone:this.phone || this.workerDetail.phone,

                    idCard:this.idCard || this.workerDetail.idCard,

                    idFrontUrl:this.idFrontUrl || this.workerDetail.idFrontUrl,

                    idBackUrl:this.idBackUrl || this.workerDetail.idBackUrl,

                    wx_head_url:this.workerDetail.wx_head_url,

                    wxName:this.workerDetail.wxName,
                ...
                $.ajax({
                    ...
                    url:"http://118.24.136.82/index.php/index/Company_staff/edit",
